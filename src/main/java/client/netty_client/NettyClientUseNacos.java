...
//
//    public NettyClientUseNacos(String registryAddr, String serializerType) {
//        int code = SerializerCode.valueOf(serializerType).getCode();
//        this.serializer = Serializer.getByCode(code);
//        this.serviceRegistry = new NacosServiceRegistry(registryAddr);  // todo: 不应该创建新的注册中心，而应该根据地址获取。
//
